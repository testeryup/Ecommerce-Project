...
import { getTransactionStats, getTransactions, approveWithdraw, rejectWithdraw } from '../../services/adminService';
...
const TransactionsManagement = () => {
  ...
  const fetchTransactions = async (params = {}) => {
    try {
      ...
      toast.error('Đã xảy ra lỗi khi tải danh sách giao dịch');
    } finally {
      setLoading(false);
    }
  };
